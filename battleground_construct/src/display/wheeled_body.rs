...
const WHEELED_BODY_HEIGHT: f32 = 0.125;
...
impl Drawable for WheeledBody {
    fn drawables(&self) -> Vec<Element> {
        ...
        vec![
            ...
            Element {
                transform: Mat4::from_translation(Vec3::new(WHEELED_BODY_WHEELBASE, 0.0, WHEELED_BODY_AXLE_OFFSET)),
                primitive: Primitive::Cuboid(Cuboid {
                    length: WHEELED_BODY_AXLE_RADIUS,
                    width: self.width + WHEELED_BODY_AXLE_PROTRUSION * 2.0,
                    height: WHEELED_BODY_AXLE_RADIUS,
            ...
            Element {
                transform: Mat4::from_translation(Vec3::new(WHEELED_BODY_ORIGIN_SHIFT, 0.4, WHEELED_BODY_HEIGHT / 2.0 + 0.01)),
                primitive: Primitive::Cuboid(Cuboid {
